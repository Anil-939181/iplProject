  ...
  return (
    <div className="flex flex-wrap w-full">
      {matchesData.map(({matchDetailsMap:{match,key:date}},i)=>
          ...
          match.map(({matchInfo:{team1:{teamSName:team1SName,teamName:team1LongName,imageId:team1Img},team2:{teamSName:team2SName,teamName:team2longName,imageId:team2Img},status,matchId,matchDesc,matchFormat,state},matchScore},i)=>(
            <Link key={i} to={`/matchDetail/${matchId}`} className="w-[50%] border h-[150px] sm:h-[130px] ">
            ...
            <div className="bg-gray-800 text-white text-sm p-3 flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between">
                        <div className="flex gap-4">
                            <img className="w-5 object-contain" src={"https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/"+team1Img} alt="" />
                        <p>{team1SName}</p>
                        </div>

                        
                        {
                            state=="Upcoming"?"":matchScore?.team1Score?<p>{matchScore?.team1Score?.inngs1?.runs}/{matchScore?.team1Score?.inngs1?.wickets}({matchScore?.team1Score?.inngs1?.overs})</p>:""
                        }
                    ...
                    <div className="flex justify-between">
                        <div className="flex gap-4">
                            <img className="w-5" src={"https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/"+team2Img} alt="" />
                        <p>{team2SName}</p>
                        </div>
                         
                        {
                             state=="Upcoming"?"":matchScore?.team2Score?<p>{matchScore?.team2Score?.inngs1?.runs}/{matchScore?.team2Score?.inngs1?.wickets}({matchScore?.team2Score?.inngs1?.overs})</p>:""
                        }
               ...
               {console.log(team1SName)
                ...
                <p>
                    {state === "Upcoming"
  ? status:status.split(" won")[0].toLowerCase() === team1LongName.toLowerCase()
    ? team1SName + " won " + status.split("won ")[1]
    : team2SName + " won " + status.split("won ")[1]
  }
