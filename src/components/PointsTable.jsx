  ...
  return (
    <div className='w-full p-3'>
      <table className='w-full p-5'>
        <tr className='text-center w-full h-[40px]'>
        ...
        {   
            tableData.length<=0?<h1>Loading</h1>:tableData.map(
              (
                ...
                teamImageId}
                ,i)=>(
                <tr key={i} className='text-center w-full border-t border-gray-500 h-[40px] text-sm' >
                  <div className='flex gap-1 mb-2 items-center sm:gap-5'>
                    <td className='w-4'>{i+1}</td>
                    <img className="w-5 object-contain" src={"https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/"+teamImageId} alt="" />
                    <td>{teamName}</td>
                  </div>
